...
load('/Users/dnplserv/vmPFC/MEDUSA Schaefer Analysis/vmPFC_HC_model_selection/2024-04-04-Explore-Granger-Causality-pred-vmPFC-network-feedback-with-group2-4.Rdata')
Xuni <- ddf;
...
load('/Users/dnplserv/vmPFC/MEDUSA Schaefer Analysis/vmPFC_HC_model_selection/2024-04-04-Explore-Granger-Causality-pred-vmPFC-network-feedback-with-group2-1.Rdata')
Xbi <- ddf;
...
load('/Users/dnplserv/vmPFC/MEDUSA Schaefer Analysis/vmPFC_HC_model_selection/2024-04-04-Explore-Granger-Causality-pred-HC-network-feedback-with-group2-4.Rdata')
Yuni <- ddf;
...
load('/Users/dnplserv/vmPFC/MEDUSA Schaefer Analysis/vmPFC_HC_model_selection/2024-04-04-Explore-Granger-Causality-pred-HC-network-feedback-with-group2-1.Rdata')
Ybi <- ddf;
