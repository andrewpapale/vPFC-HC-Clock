plot_mixed_by_vmPFC_HC_Age <- function(ddf,toalign,toprocess,totest,behavmodel,model_iter,hc_LorR,CTRflag,flipy){
  library(grid)
  library(pracma)
  ...
  if (strcmp(toalign,"clock")){
    setwd('~/vmPFC/MEDUSA Schaefer Analysis/Age_vPFC_HC_clock')
  } else if (strcmp(toalign,"feedback")){
    setwd('~/vmPFC/MEDUSA Schaefer Analysis/Age_vPFC_HC_feedback')
  }
