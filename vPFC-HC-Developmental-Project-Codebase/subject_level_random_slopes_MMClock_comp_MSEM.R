...
mDMNage_bsocial_fmri_AH <- lmerTest::lmer(data=Qb %>% filter(network=='DMN' & HC_region == 'AH'), rt_csv ~ rt_lag_sc*age*subj_level_rand_slope + rt_vmax_lag_sc*age*subj_level_rand_slope + rt_lag_sc*trial_neg_inv_sc + rt_lag_sc*reward_lag_rec + (1|id/run))
mCTRage_bsocial_fmri_AH <- lmerTest::lmer(data=Qb %>% filter(network=='CTR' & HC_region == 'AH'), rt_csv ~ rt_lag_sc*age*subj_level_rand_slope + rt_vmax_lag_sc*age*subj_level_rand_slope + rt_lag_sc*trial_neg_inv_sc + rt_lag_sc*reward_lag_rec + (1|id/run))
mLIMage_bsocial_fmri_AH <- lmerTest::lmer(data=Qb %>% filter(network=='LIM' & HC_region == 'AH'), rt_csv ~ rt_lag_sc*age*subj_level_rand_slope + rt_vmax_lag_sc*age*subj_level_rand_slope + rt_lag_sc*trial_neg_inv_sc + rt_lag_sc*reward_lag_rec + (1|id/run))
mDMNage_bsocial_fmri_PH <- lmerTest::lmer(data=Qb %>% filter(network=='DMN' & HC_region == 'PH'), rt_csv ~ rt_lag_sc*age*subj_level_rand_slope + rt_vmax_lag_sc*age*subj_level_rand_slope + rt_lag_sc*trial_neg_inv_sc + rt_lag_sc*reward_lag_rec + (1|id/run))
mCTRage_bsocial_fmri_PH <- lmerTest::lmer(data=Qb %>% filter(network=='CTR' & HC_region == 'PH'), rt_csv ~ rt_lag_sc*age*subj_level_rand_slope + rt_vmax_lag_sc*age*subj_level_rand_slope + rt_lag_sc*trial_neg_inv_sc + rt_lag_sc*reward_lag_rec + (1|id/run))
mLIMage_bsocial_fmri_PH <- lmerTest::lmer(data=Qb %>% filter(network=='LIM' & HC_region == 'PH'), rt_csv ~ rt_lag_sc*age*subj_level_rand_slope + rt_vmax_lag_sc*age*subj_level_rand_slope + rt_lag_sc*trial_neg_inv_sc + rt_lag_sc*reward_lag_rec + (1|id/run))


####PLOTTING RT SWINGS
em3a <- as_tibble(emmeans::emtrends(mDMNage_bsocial_fmri_AH, var = "rt_lag_sc", specs = c("subj_level_rand_slope", "age") ,at = list(subj_level_rand_slope = c(-1.5,1.5), age = c(-1.5,1.5))))
em3a$subj_level_rand_slope <- factor(em3a$subj_level_rand_slope, levels = c(-1.5, 1.5), labels = c("low", "high"))
em3a$age <- factor(em3a$age, levels = c(-1.5, 1.5), labels = c("younger", "older"))
##basic palette plot
ggplot(em3a, aes(x = subj_level_rand_slope, y = rt_lag_sc.trend, ymin = asymp.LCL, ymax = asymp.UCL, color = age)) +
...
####PLOTTING RT SWINGS
em3a <- as_tibble(emmeans::emtrends(mCTRage_bsocial_fmri_AH, var = "rt_lag_sc", specs = c("subj_level_rand_slope", "age") ,at = list(subj_level_rand_slope = c(-1.5,1.5), age = c(-1.5,1.5))))
em3a$subj_level_rand_slope <- factor(em3a$subj_level_rand_slope, levels = c(-1.5, 1.5), labels = c("low", "high"))
em3a$age <- factor(em3a$age, levels = c(-1.5, 1.5), labels = c("younger", "older"))
##basic palette plot
ggplot(em3a, aes(x = subj_level_rand_slope, y = rt_lag_sc.trend, ymin = asymp.LCL, ymax = asymp.UCL, color = age)) +
...
####PLOTTING RT SWINGS
em3a <- as_tibble(emmeans::emtrends(mLIMage_bsocial_fmri_AH, var = "rt_lag_sc", specs = c("subj_level_rand_slope", "age") ,at = list(subj_level_rand_slope = c(-1.5,1.5), age = c(-1.5,1.5))))
em3a$subj_level_rand_slope <- factor(em3a$subj_level_rand_slope, levels = c(-1.5, 1.5), labels = c("low", "high"))
em3a$age <- factor(em3a$age, levels = c(-1.5, 1.5), labels = c("younger", "older"))
##basic palette plot
ggplot(em3a, aes(x = subj_level_rand_slope, y = rt_lag_sc.trend, ymin = asymp.LCL, ymax = asymp.UCL, color = age)) +
...
####PLOTTING RT SWINGS
em3a <- as_tibble(emmeans::emtrends(mDMNage_bsocial_fmri_PH, var = "rt_lag_sc", specs = c("subj_level_rand_slope", "age") ,at = list(subj_level_rand_slope = c(-1.5,1.5), age = c(-1.5,1.5))))
em3a$subj_level_rand_slope <- factor(em3a$subj_level_rand_slope, levels = c(-1.5, 1.5), labels = c("low", "high"))
em3a$age <- factor(em3a$age, levels = c(-1.5, 1.5), labels = c("younger", "older"))
##basic palette plot
ggplot(em3a, aes(x = subj_level_rand_slope, y = rt_lag_sc.trend, ymin = asymp.LCL, ymax = asymp.UCL, color = age)) +
...
####PLOTTING RT SWINGS
em3a <- as_tibble(emmeans::emtrends(mCTRage_bsocial_fmri_PH, var = "rt_lag_sc", specs = c("subj_level_rand_slope", "age") ,at = list(subj_level_rand_slope = c(-1.5,1.5), age = c(-1.5,1.5))))
em3a$subj_level_rand_slope <- factor(em3a$subj_level_rand_slope, levels = c(-1.5, 1.5), labels = c("low", "high"))
em3a$age <- factor(em3a$age, levels = c(-1.5, 1.5), labels = c("younger", "older"))
##basic palette plot
ggplot(em3a, aes(x = subj_level_rand_slope, y = rt_lag_sc.trend, ymin = asymp.LCL, ymax = asymp.UCL, color = age)) +
...
####PLOTTING RT SWINGS
em3a <- as_tibble(emmeans::emtrends(mLIMage_bsocial_fmri_PH, var = "rt_lag_sc", specs = c("subj_level_rand_slope", "age") ,at = list(subj_level_rand_slope = c(-1.5,1.5), age = c(-1.5,1.5))))
em3a$subj_level_rand_slope <- factor(em3a$subj_level_rand_slope, levels = c(-1.5, 1.5), labels = c("low", "high"))
em3a$age <- factor(em3a$age, levels = c(-1.5, 1.5), labels = c("younger", "older"))
##basic palette plot
ggplot(em3a, aes(x = subj_level_rand_slope, y = rt_lag_sc.trend, ymin = asymp.LCL, ymax = asymp.UCL, color = age)) +
