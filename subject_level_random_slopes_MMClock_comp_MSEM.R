...
mDMNsex <- lmerTest::lmer(data=Q2 %>% filter(network=='DMN'), rt_csv ~ rt_lag_sc*sex*subj_level_rand_slope + rt_vmax_lag_sc*sex*subj_level_rand_slope + rt_lag_sc*trial_neg_inv_sc + rt_lag_sc*reward_lag_rec + (1|id/run))
mCTRsex <- lmerTest::lmer(data=Q2 %>% filter(network=='CTR'), rt_csv ~ rt_lag_sc*sex*subj_level_rand_slope + rt_vmax_lag_sc*sex*subj_level_rand_slope + rt_lag_sc*trial_neg_inv_sc + rt_lag_sc*reward_lag_rec + (1|id/run))
mLIMsex <- lmerTest::lmer(data=Q2 %>% filter(network=='LIM'), rt_csv ~ rt_lag_sc*sex*subj_level_rand_slope + rt_vmax_lag_sc*sex*subj_level_rand_slope + rt_lag_sc*trial_neg_inv_sc + rt_lag_sc*reward_lag_rec + (1|id/run))
