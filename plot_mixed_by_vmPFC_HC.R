plot_mixed_by_vmPFC_HC <- function(ddf,toalign,toprocess,totest,behavmodel,model_iter,hc_LorR,CTRflag,flipy){
  ...
  if (strcmp(toprocess,'network-by-HC') | strcmp(toprocess,'network-by-HC-by-side') | strcmp(toprocess,'network-by-HC-by-scanner') | strcmp(toprocess,'network-by-HC-by-rewFunc') | strcmp(toprocess,'network-by-HC-by-side')){
